  ...
  return (
    <div className="why-use-container">
      ...
      <div className="why-use-sections">
        <SectionBox id="tool" icon="🎯" title="Why This Tool?">
          <p>
        ...
        <SectionBox id="meditation" icon="🧘" title="Why Meditation?">
          <p>
        ...
        <SectionBox id="mood" icon="🎭" title="Why Mood Tracking?">
          <p>
        ...
        <SectionBox id="diary" icon="📔" title="Why Keep a Diary?">
          <p>
        ...
        <SectionBox id="weight" icon="⚖️" title="Why Track Weight?">
          <p>
        ...
        <SectionBox id="framework" icon="🌱" title="The Integrated Recovery Approach">
          <p>
        ...
        <SectionBox id="stats" icon="📊" title="Recovery Works">
        ...
        <SectionBox id="final" icon="❤️" title="You've Got This">
          <p>
