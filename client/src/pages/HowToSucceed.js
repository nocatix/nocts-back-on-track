...
const HowToSucceed = () => {
  ...
  const SectionBox = ({ id, icon, title, children }) => {
    ...
    return (
      <section className={`how-to-succeed-section ${isExpanded ? 'expanded' : 'collapsed'}`}>
        <div className="how-to-succeed-section-header" onClick={() => toggleSection(id)}>
  ...
  return (
    <div className="how-to-succeed-container">
      ...
      <div className="how-to-succeed-sections">
        <SectionBox id="honesty" icon="🎯" title="Be Honest With Yourself">
          <p>
        ...
        <SectionBox id="kindness" icon="💝" title="Be Kind to Yourself">
          <p>
        ...
        <SectionBox id="support" icon="🚀" title="Build Your Support System">
          <p>
        ...
        <SectionBox id="cravings" icon="🧠" title="Master Your Cravings">
          <p>
        ...
        <SectionBox id="emotional" icon="🧘" title="Prioritize Emotional Wellness">
          <p>
        ...
        <SectionBox id="physical" icon="💪" title="Take Care of Your Body">
          <p>
        ...
        <SectionBox id="purpose" icon="✨" title="Find Your Purpose">
          <p>
        ...
        <SectionBox id="final" icon="❤️" title="You Are Worth It">
          <p>
